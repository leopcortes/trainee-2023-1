...
RSpec.describe "Api::Categories", type: :request do
  ...
  describe "GET /index" do
    before do
      create(:category, id:1, name:"Jogos", description:"Valorant/LOL/COD/Minecraft/Fornite/etc")
      create(:category, id:2, name:"TV", description:"Filmes/Series/Canais/Programas/etc")
    end
    context 'when index return' do
      ...
      #     'id' => 1,
      #     'name' => "Jogos",
      #     'description' => "Valorant/LOL/COD/Minecraft/Fornite/etc"
      #   },
      #   {
      #     'id' => 2,
      #     'name' => "TV",
      #     'description' => "Filmes/Series/Canais/Programas/etc"
      #   }
      #   ])
      # end
    end
